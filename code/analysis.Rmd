...
# Read in data from Git
```{r}
urlfile="https://raw.githubusercontent.com/markowskijustin/APMs/main/data_processed/analyticalfile.csv?token=GHSAT0AAAAAACFYJHV6Y3XRLFSS7IL7YIRWZGIHWMA"

df.apm <- read_csv(url(urlfile)) %>% 
  group_by(BHCMISID)
